...
<body>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="/resources/index.html"><img src="/resources/images/home/logo2.png" alt="" /></a>
						</div>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="/resources/checkout.html"><i class="fa fa-heart" aria-hidden="true"></i></a></li>
								<li><a href="/resources/cart.html"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a></li>
								<li><a href="/resources/login.html"><i class="fa fa-lock" aria-hidden="true"></i></a></li>
							</ul>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="search_box"align="right">
							...
							<input type="submit" name="" value="화이팅!">
							</form>
						</div>
					</div>
				</div>
							...
							<div class="product-image-wrapper">
								<div class="col-sm-4">
									<div class="product-image-wrapper">
										<div class="card">
											<div class="imgBx">
												<img alt="" src="/resources/img/model/1.jpg">
												<ul class="showAction">
													...
													<li><i class="fa fa-eye" aria-hidden="true"></i> <span>View
															Details</span></li>
												</ul>
											</div>
											<div class="content">
						...
						<div class="itemContainer">
							<div class="product-image-wrapper">
								<div class="col-sm-4">
									<div class="card">
										<div class="imgBx">
											<img alt="" src="/resources/img/model/2.jpg">
											<ul class="showAction">
												<li><i class="fa fa-heart" aria-hidden="true"></i> <span>Add
														to Wishlist</span></li>
												<li><i class="fa fa-shopping-cart" aria-hidden="true"></i>
						...
						<div class="itemContainer">
							<div class="product-image-wrapper">
								<div class="col-sm-4">
									<div class="card">
										<div class="imgBx">
											<img alt="" src="/resources/img/model/3.jpg">
											<ul class="showAction">
												<li><i class="fa fa-heart" aria-hidden="true"></i> <span>Add
														to Wishlist</span></li>
												<li><i class="fa fa-shopping-cart" aria-hidden="true"></i>
						...
						<div class="itemContainer">
							<div class="product-image-wrapper">
								<div class="col-sm-4">
									<div class="card">
										<div class="imgBx">
											<img alt="" src="/resources/img/model/4.jpg">
											<ul class="showAction">
												<li><i class="fa fa-heart" aria-hidden="true"></i> <span>Add
														to Wishlist</span></li>
												<li><i class="fa fa-shopping-cart" aria-hidden="true"></i>
						...
						<div class="itemContainer">
							<div class="product-image-wrapper">
								<div class="col-sm-4">
									<div class="card">
										<div class="imgBx">
											<img alt="" src="/resources/img/model/5.jpg">
											<ul class="showAction">
												<li><i class="fa fa-heart" aria-hidden="true"></i> <span>Add
														to Wishlist</span></li>
												<li><i class="fa fa-shopping-cart" aria-hidden="true"></i>
											...
											<div class="price_rating">
												...
												<div calss="rating">
													<i class="fa fa-star" aria-hidden="true"></i> <i
														class="fa fa-star" aria-hidden="true"></i> <i
														class="fa fa-star" aria-hidden="true"></i> <i
														class="fa fa-star grey" aria-hidden="true"></i> <i
														class="fa fa-star grey" aria-hidden="true"></i>
												</div>
											</div>
										</div>
									</div>
						...
						<div class="itemContainer">
							<div class="product-image-wrapper">
								<div class="col-sm-4">
									<div class="card">
										<div class="imgBx">
											<img alt="" src="/resources/img/model/6.jpg">
											<ul class="showAction">
												<li><i class="fa fa-heart" aria-hidden="true"></i> <span>Add
														to Wishlist</span></li>
												<li><i class="fa fa-shopping-cart" aria-hidden="true"></i>
						...
						<div class="itemContainer">
							<div class="product-image-wrapper">
								<div class="col-sm-4">
									<div class="card">
										<div class="imgBx">
											<img alt="" src="/resources/img/model/7.jpg">
											<ul class="showAction">
												<li><i class="fa fa-heart" aria-hidden="true"></i> <span>Add
														to Wishlist</span></li>
												<li><i class="fa fa-shopping-cart" aria-hidden="true"></i>
						...
						<div class="itemContainer">
							<div class="product-image-wrapper">
								<div class="col-sm-4">
									<div class="card">
										<div class="imgBx">
											<img alt="" src="/resources/img/model/8.jpg">
											<ul class="showAction">
												<li><i class="fa fa-heart" aria-hidden="true"></i> <span>Add
														to Wishlist</span></li>
												<li><i class="fa fa-shopping-cart" aria-hidden="true"></i>
						...
						<div class="itemContainer">
							<div class="product-image-wrapper">
								<div class="col-sm-4">
									<div class="card">
										<div class="imgBx">
											<img alt="" src="/resources/img/model/9.jpg">
											<ul class="showAction">
												<li><i class="fa fa-heart" aria-hidden="true"></i> <span>Add
														to Wishlist</span></li>
												<li><i class="fa fa-shopping-cart" aria-hidden="true"></i>
	...
	<div class="navigation">
		...
		<ul>
			...
			<li><a href="#"> <span class="icon"><i
						class="fa fa-comment" aria-hidden="true"></i></span> <span class="title">문자</span>
			</a></li>
			<li><a href="#"> <span class="icon"><i
						class="fa fa-lock" aria-hidden="true"></i></span> <span class="title">로그인</span>
			</a></li>
			<li><a href="#"> <span class="icon"><i
						class="fa fa-cog" aria-hidden="true"></i></span> <span class="title">설정</span>
			</a></li>
			<li><a href="#"> <span class="icon"><i
